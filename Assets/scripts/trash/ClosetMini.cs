...
public class ClosetMini : MonoBehaviour
{
    public TextMeshProUGUI fillPercent;

    public GameObject closetMini;


    public Animator closetMiniAnim;
    ...
    IEnumerator coroutineStart()
    {
        while (true)
        {
            ...
            closetMiniAnim.SetTrigger("closetMiniStart");
        }
    }
}
